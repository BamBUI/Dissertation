...
/*
    ...
    @JoinColumn(name = "subAssemblyCPN")
    private CPN subAssemblyCPN;

    @OneToOne(targetEntity = DPN.class, fetch = FetchType.LAZY)
    @JoinColumn(name = "subAssemblyDPN")
    private DPN subAssemblyDPN;
 ...
 */
    ...
    @Column(length = 25, name = "destination")
    private String destination;

    @Column(length = 25, name = "cavity")
    private String cavity;

    @Column(length = 25, name = "supplierPN")
    private String supplierPN;

    @Column(length = 25, name = "supplier")
    private String supplier;

    @Column(length = 25, name = "quantity")
    private int quantity;

    @Column (length = 25, name = "category")
    private String category;

    @Column (length = 25, name = "layer")
    private String layer;

    @Column (length = 25, name = "options")
    private String options;

    @Column (length = 25, name = "partType")
    ...
    public Layer getLayer() {
        return layer == null ? null : Layer.fromId(layer);
    }
